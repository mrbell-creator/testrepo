...
def parse_payload(hex_payload):
    ...
    try:
        ...
        logging.debug("[parse_payload] Detected GEN2 sensor.")
...
def get_example_hex_strings():
    return [
        ...
        "1AFF0D000002AC67153CE04100000C30C000036C9080074D287B270302A0AD",  # Empty
    ]
