...
def parse_gen2_payload(mfrData):
...
def parse_xl_payload(mfrData):
    # Placeholder for XL sensor parsing
    return {
        "hardware_family": "xl",
        "advertisement_peaks": [],
        "note": "XL parsing not implemented yet."
    }
...
def parse_payload(hex_payload):
    ...
    try:
        ...
        parsed = parse_xl_payload(mfrData) if is_xl else parse_gen2_payload(mfrData)
